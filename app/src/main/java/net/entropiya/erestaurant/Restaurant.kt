...
val dummyRestaurants = listOf(
    ...
    Restaurant(14, "Food and coffee", "Drink your coffee and then have lunch at FaC!"),
    Restaurant(15, "Pizza and burgers Brazil", "Get your best burgers and pizza here in Brazil!"),
    Restaurant(16, "Spicy Grill Toronto", "Get the best culinary experience in Toronto."),
)