...
fun RestaurantsScreen(
    state: RestaurantsScreenState, onItemClick: (id: Int) -> Unit, onFavoriteClick: (id: Int, oldValue: Boolean) -> Unit
) {
    Box(
...
fun DefaultPreview() {
    ERestaurantTheme {
        RestaurantsScreen(RestaurantsScreenState(listOf(), false), {}, { _, _ -> })
    }
}